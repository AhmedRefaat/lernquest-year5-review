# LLM Integration Prompt: Catch the Falling Stars

You are integrating the self-contained `falling_stars` ES module into the existing LernQuest application.
...
## Game intent
The learner moves a rocket to catch falling stars and rare diamonds using keyboard or touch controls, maintaining score and position.

## Required integration behavior

1. Place this directory at `src/games/game_falling_stars`.
2. Import `createGame` from `./games/game_falling_stars/game.js` from the host game manager.
