# LLM Integration Prompt: Balloon Pop Challenge

You are integrating the self-contained `balloon_pop` ES module into the existing LernQuest application.
...
## Game intent
The learner quickly pops colorful balloons. Normal balloons grant one point and rare rainbow balloons grant five, with a best-combo record.

## Required integration behavior

1. Place this directory at `src/games/game_balloon_pop`.
2. Import `createGame` from `./games/game_balloon_pop/game.js` from the host game manager.
...
```javascript
import { createGame } from './games/game_balloon_pop/game.js';
