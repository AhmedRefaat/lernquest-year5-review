# LLM Integration Prompt: Treasure Chest Adventure

You are integrating the self-contained `treasure_chest` ES module into the existing LernQuest application.
...
## Game intent
The learner opens repeatable surprise chests and collects coins, diamonds, and puzzle pieces. Every chest is positive; rare rewards create anticipation without punishment.

## Required integration behavior

1. Place this directory at `src/games/game_treasure_chest`.
2. Import `createGame` from `./games/game_treasure_chest/game.js` from the host game manager.
...
```javascript
import { createGame } from './games/game_treasure_chest/game.js';
