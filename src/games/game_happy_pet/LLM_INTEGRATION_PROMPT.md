# LLM Integration Prompt: Feed and Grow Your Pet

You are integrating the self-contained `happy_pet` ES module into the existing LernQuest application.
...
## Game intent
The learner feeds a persistent dragon, earns XP, levels it up, and unlocks accessories. Long-term pet growth is the main motivation.

## Required integration behavior

1. Place this directory at `src/games/game_happy_pet`.
2. Import `createGame` from `./games/game_happy_pet/game.js` from the host game manager.
...
```javascript
import { createGame } from './games/game_happy_pet/game.js';
